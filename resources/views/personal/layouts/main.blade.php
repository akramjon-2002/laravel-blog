    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
           ...
           @auth()
            <ul class="navbar-nav">
                <li class="nav-item">
                    <form action="{{route('admin.main.index')}}" method="get">
                        ...
                        <input type="submit" value="Admin Panel" class="btn btn-outline-primary" >
                    </form>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <form action="{{route('home.post.index')}}" method="get">

                        <input type="submit" value="Blog" class="btn btn-outline-primary" >
                    </form>
                </li>
            </ul>
